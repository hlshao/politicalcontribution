<template>
  <aside class="aside-nav">
    ...
    <router-link class="nav-router-link" id="text" to="/story1" @click.native="scroll('story1')" onclick="ga('send', 'event', 'projects', 'click', 'side to article', { nonInteraction: false })"><span class="tooltiptext">獻金解析文章</span></router-link>
...
.aside-nav
  ...
  a
    ...
    //     background-image url('~assets/images/page-nav/paper-blue.png')
    &#text
      background-image url('~assets/images/page-nav/text-white.png')
      &:hover
        background-image url('~assets/images/page-nav/text-blue.png')
      &.router-link-active
        background-image url('~assets/images/page-nav/text-blue.png')
    &#notice
